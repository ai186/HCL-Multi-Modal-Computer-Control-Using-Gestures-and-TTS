...
BLIND_SCRIPT = os.path.join(CURRENT_DIR, "Blind.py")
...
def launch_blind():
    Thread(target=run_script, args=(BLIND_SCRIPT,)).start()
...
def main_gui():
    ...
    # Blind
    tk.Label(root, text="Blind", font=("Arial", 14)).pack(pady=10)
    tk.Button(root, text="Launch", command=launch_blind, width=15, bg="green", fg="white").pack()
